  ...
  return (
    ...
    >
     ...
     {showlogin && (
      ...
      {/* this is a modal including all the information */}
      <Container className="details-of-the-item">
        <Row className="night-upper-row">
          <h1 className="center-title">
            <b>{itemName}</b>
          </h1>
        </Row>
        <Row className="night-middle-top-row row1">
          <Col className="col1" sm="12" md="6" lg="5" xl="5">
            <Row className="row1 center-items">
              ...
              <span
                className="night-ingredients-text"
                style={{
                  marginTop: "15px",
                  color: "#1d1d1d",
                }}
          ...
          <Col className="col1" sm="0" md="6" lg="7" xl="7">
            <Row style={{margin:"auto"}} className="row1">
              <span className="night-product-name">Description</span>
            ...
            {thisItemExtra.length > 0 ? (
              <div style={{ marginTop: "10px", marginBottom: "10px" }}>
                {" "}
                <span className="night-extra-ingredients-title">
              ...
              <div>
                <p className="night-extra-ingredients-title">No extra ingredients</p>
              </div>
            )}
        ...
        <Row className="row1 border-line-top margin-top-row">
          ...
          <div style={{marginTop:"3px"}}  className="d-flex justify-content-evenly">
              <b className="night-quantity-label">Quantity</b>
            

            <Button
              variant="light"
              className="night-minus-plus-btn"
              onClick={removeQuantity}
            >
             -
{/* <b style={{display:"block", height:"30px", lineHeight:"20px"}}>-</b>
 */}            </Button>
            <TextField
          ...
          >
            <button
              className="night-btn-add-to-cart-modal"
...
export default NightItemDetails;
